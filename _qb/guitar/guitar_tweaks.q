destroy_time = 1.0
ghighwaytiling1 = 2.1 // 0.012 * length + 0.3
highway_playline1 = 655
highway_height1 = 455 // "150%", 2.1 * length + 140
highway_top_width1 = 52 // -2.16 * length + 376
//highway_bottom_width1 = 512
widthoffsetfactor1 = 8.85 // (512 / top_width) - 1
highway_fade1 = 30.0
gem_start_scale1 = 0.0805 // -0.0034 * length + 0.59
gem_end_scale1 = 0.8
gem_star_scale1 = 1.3
gem_y_just1 = 0.83
star_y_just1 = 0.5
fretbar_start_scale1 = 0.0486 // -0.00203 * length + 0.353
//fretbar_end_scale1 = 0.48
whammy_top_width1 = 3.5 // -0.13 * length + 23
//whammy_bottom_width1 = 28
whammy_width_offset1 = 8.45 // (28 / top_width) -1
sidebar_x_offset1 = 4.0
sidebar_x_scale1 = 0.3
sidebar_y_scale1 = 1.27 // 0.0054 * length + 0.46
